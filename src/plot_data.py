...
def main():
	...
	plt.axis([min_x_bounds, max_x_bounds, min_y_bounds, max_y_bounds])

	#font = {'fontname':'Times New Roman'}

	plt.suptitle('Real-World Magnetic Field Strength at Differing Distances')
	plt.xlabel('Distance to Boundary Loop',fontsize=12)
